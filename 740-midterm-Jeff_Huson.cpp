...
int main(int argc, char* argv[])
{
    ...
    if (argc < 2 || argc > 3)
    {
        cout << "Invalid number of arguments. Please enter <740-midterm-Jeff_Huson.exe> followed by a <directory path>, then an optional </s> switch for a recursive search and listing or </q> to display file owner." << endl;
        return 1;
    }
    ...
    if (argc == 3)
    {
        ...
        {
            cout << "Invalid second argument. Please enter one of the following: s/, or q/." << endl;
            return 1;
